...
for model in CABLE-POP CLASS-CTEM CLM5.0 JSBACH OCN ORCHIDEE-CNP ORCHIDEE SURFEX; do
...
for model in CABLE-POP CLASS-CTEM CLM5.0 DLEM ISAM JSBACH LPJ LPJ-GUESS LPX OCN ORCHIDEE-CNP ORCHIDEE SURFEX VISIT; do
