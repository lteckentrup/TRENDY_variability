...
for model in CABLE-POP DLEM OCN ORCHIDEE-CNP ORCHIDEE SDGVM VISIT; do
    cdo -b F64 -L -invertlat -ymonmean -selyear,1960/2017 \
        ../../S2/gpp/$model'_'S2_gpp.nc \
        $model'_'S2_gpp_climatology.nc
    cdo -b F64 -L -invertlat -selyear,1901/2017 \
        ../../S2/gpp/$model'_'S2_gpp.nc $model'_'S2_gpp.nc
...
for model in CABLE-POP CLM5.0 OCN ORCHIDEE-CNP ORCHIDEE SDGVM SURFEX; do
